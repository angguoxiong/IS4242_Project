...
def run_item_based_knn_CF(ratings_df):
    ...
    # Use item-based k-NN with pearson baseline similarity
    ...
    # Find the 5 most similar movies for each movie
    ...
    for user in all_user_ids:
        ...
        # Append the top 5 most similar movie to each of their top rated movies
...
def run_user_based_knn_CF(ratings_df):
    ...
    # Find 3 other similar users to the current user
    user_recommendations = {}
    for user_id in all_user_ids:
        ...
        # Find the top 1% of movies rated highest for each of the similar users
